...
namespace OBJS.API.Migrations
{
    ...
    [Migration("20200401123802_initialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OBJS.API.Models.Advertises.Advertise", b =>
                {
                    b.HasOne("OBJS.API.Models.Advertises.AdvertiseState", "Advertisestate")
                        .WithOne("Advertise")
                        .HasForeignKey("OBJS.API.Models.Advertises.Advertise", "AdvertiseStateId")
            ...
            modelBuilder.Entity("OBJS.API.Models.Advertises.Feedback", b =>
                {
                    b.HasOne("OBJS.API.Models.Advertises.Advertise", "Advertises")
                        .WithOne("Feedback")
                        .HasForeignKey("OBJS.API.Models.Advertises.Feedback", "AdvertiseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OBJS.API.Models.Categories.Category", b =>
                {
                    b.HasOne("OBJS.API.Models.Categories.Category", "Parent")
                        .WithMany("Child")
